...
<div class="page-header">
    ...
    <p class="page-desc">
        ...
        <?php if($lastVisit): ?>
            &nbsp;·&nbsp; Kunjungan terakhir: <span style="color:var(--primary)"><?php echo e($lastVisit); ?></span>
        <?php endif; ?>
    </p>
</div>
...
<div class="stat-grid">
    <div class="stat-card orange">
        ...
        <div class="stat-value" id="statPesanan"><?php echo e($totalPesananHariIni); ?></div>
    ...
    <div class="stat-card green">
        ...
        <div class="stat-value" style="font-size:20px" id="statPendapatan">Rp <?php echo e(number_format($totalPendapatanHariIni, 0, ',', '.')); ?></div>
    ...
    <div class="stat-card yellow">
        ...
        <div class="stat-value" id="statProses"><?php echo e($totalProses); ?></div>
    ...
    <div class="stat-card blue">
        ...
        <div class="stat-value" id="statSelesai"><?php echo e($totalSelesai); ?></div>
                    ...
                    <div class="service-grid" id="serviceCardGrid">
                        <?php $__empty_1 = true; $__currentLoopData = $layanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="service-card-select"
                                 ...
                                 data-name="<?php echo e($l->nama_layanan); ?>"
                                 data-price="<?php echo e($l->harga); ?>">
                                <div class="service-card-name"><?php echo e($l->nama_layanan); ?></div>
                                <div class="service-card-price">Rp <?php echo e(number_format($l->harga, 0, ',', '.')); ?></div>
                            </div>
        ...
        <div class="card mb-4">
            <div class="filter-bar" style="border-radius:var(--radius-lg) var(--radius-lg) 0 0;">
                <div class="filter-group">
                    ...
                    <input type="text" class="form-control" id="filterNama" placeholder="Cari nama customer..." value="<?php echo e($filterNama); ?>">
                </div>
                <div class="filter-group">
                    ...
                    <select class="form-control" id="filterLayanan">
                        ...
                        <?php $__currentLoopData = $layanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($l->id); ?>" <?php echo e($filterLayanan == $l->id ? 'selected' : ''); ?>><?php echo e($l->nama_layanan); ?></option>
            ...
            <div class="table-wrapper">
                <table id="pesananTable">
                    ...
                    <tbody id="pesananTbody">
                        <?php $__empty_1 = true; $__currentLoopData = $pesananHariIni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-id="<?php echo e($p->id); ?>">
                                <td style="color:var(--text-muted)"><?php echo e($i + 1); ?></td>
                                <td>
                                    <span style="font-weight:600"><?php echo e($p->nama_customer); ?></span>
                                    <br><span style="font-size:11px;color:var(--text-muted)"><?php echo e($p->created_at->format('H:i')); ?></span>
                                </td>
                                <td><?php echo e($p->nama_layanan); ?></td>
                                <td><?php echo e($p->jumlah_helm); ?> helm</td>
                                <td style="font-weight:700;color:var(--primary);font-family:var(--font-display)">
                                    Rp <?php echo e(number_format($p->total_harga, 0, ',', '.')); ?>

                                </td>
                                <td>
                                    <span class="badge <?php echo e($p->status === 'selesai' ? 'badge-success' : 'badge-warning'); ?>">
                                        <?php echo e(ucfirst($p->status)); ?>

                                    </span>
                                </td>
                                <td>
                                    <button class="btn btn-xs <?php echo e($p->status === 'selesai' ? 'btn-ghost' : 'btn-success'); ?>"
                                            onclick="toggleStatus(<?php echo e($p->id); ?>, this)">
                                        <?php echo e($p->status === 'selesai' ? 'Proses' : 'Selesai'); ?>
...
<script>
const STORE_URL      = "<?php echo e(route('pesanan.store')); ?>";
const STATUS_URL_BASE = "<?php echo e(url('/pesanan')); ?>";
const STATS_URL      = "<?php echo e(route('api.dashboard-stats')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\cuci_helm\resources\views/dashboard/index.blade.php ENDPATH**/ ?>