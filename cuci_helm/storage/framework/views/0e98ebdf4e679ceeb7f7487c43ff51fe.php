...
<head>
    ...
    <title><?php echo e($title ?? 'Cuci Helm Pro'); ?> - Jasa Cuci Helm</title>
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-brand">
                ...
                <div class="brand-icon" style="width:48px;height:48px;background:none;border:none;padding:0;">
                    <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="HelmWash Pro Logo" width="48" height="48"
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?php echo e(route('layanan.index')); ?>" class="nav-item <?php echo e(request()->routeIs('layanan.*') ? 'active' : ''); ?>">
                    <span class="nav-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="<?php echo e(route('transaksi.index')); ?>" class="nav-item <?php echo e(request()->routeIs('transaksi.*') ? 'active' : ''); ?>">
                    <span class="nav-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <main class="main-content">
            <header class="topbar">
                ...
                <div class="topbar-breadcrumb">
                    <span class="breadcrumb-page"><?php echo e($pageTitle ?? 'Dashboard'); ?></span>
                </div>
...
<?php /**PATH D:\cuci_helm\resources\views/layouts/app.blade.php ENDPATH**/ ?>