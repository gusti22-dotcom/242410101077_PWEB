    ...
    <div class="card">
        <div class="card-header">
            <div>
                ...
                <div class="card-subtitle"><?php echo e($layanan->count()); ?> layanan (<?php echo e($layanan->where('is_active', true)->count()); ?> aktif)</div>
            </div>
        </div>
        <div class="layanan-grid" id="layananGrid">
            <?php $__empty_1 = true; $__currentLoopData = $layanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="layanan-item <?php echo e(!$l->is_active ? 'layanan-inactive' : ''); ?>" id="layanan-item-<?php echo e($l->id); ?>">
                    <div class="layanan-info">
                        <div style="display:flex;align-items:center;gap:8px;">
                            <div class="layanan-name" style="<?php echo e(!$l->is_active ? 'color:var(--text-muted);' : ''); ?>"><?php echo e($l->nama_layanan); ?></div>
                            <span class="badge <?php echo e($l->is_active ? 'badge-success' : 'badge-warning'); ?>" style="font-size:10px;padding:2px 7px;">
                                <?php echo e($l->is_active ? 'Aktif' : 'Nonaktif'); ?>

                            </span>
                        </div>
                        <div class="layanan-price" style="<?php echo e(!$l->is_active ? 'color:var(--text-muted);' : ''); ?>">Rp <?php echo e(number_format($l->harga, 0, ',', '.')); ?></div>
                        <?php if($l->deskripsi): ?>
                            <div style="font-size:11px;color:var(--text-muted);margin-top:3px"><?php echo e($l->deskripsi); ?></div>
                        <?php endif; ?>
                    </div>
                    <div class="layanan-actions">
                        <button class="btn btn-icon btn-sm <?php echo e($l->is_active ? 'btn-ghost' : 'btn-primary'); ?>" title="<?php echo e($l->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>"
                                onclick="toggleLayanan(<?php echo e($l->id); ?>, '<?php echo e(addslashes($l->nama_layanan)); ?>', <?php echo e($l->is_active ? 'true' : 'false'); ?>)">
                            <?php if($l->is_active): ?>
                        ...
                        <button class="btn btn-icon btn-ghost btn-sm" title="Edit"
                                onclick="openEditModal(<?php echo e($l->id); ?>, '<?php echo e(addslashes($l->nama_layanan)); ?>', <?php echo e($l->harga); ?>, '<?php echo e(addslashes($l->deskripsi ?? '')); ?>')">
                        ...
                        <button class="btn btn-icon btn-danger btn-sm" title="Hapus"
                                onclick="deleteLayanan(<?php echo e($l->id); ?>, '<?php echo e(addslashes($l->nama_layanan)); ?>')">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:14px;height:14px;">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <?php $__currentLoopData = $layanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $countPesanan = $l->pesanan()->count(); ?>
                    <div id="statistik-item-<?php echo e($l->id); ?>" style="display:flex;justify-content:space-between;align-items:center;padding:10px 0;border-bottom:1px solid var(--border);last-child:{border:none}">
                        <div>
                            <div style="font-size:13px;font-weight:600;color:var(--text-primary)"><?php echo e($l->nama_layanan); ?></div>
                            <div style="font-size:11px;color:var(--text-muted)"><?php echo e($countPesanan); ?> total pesanan</div>
                        </div>
...
<script>
const LAYANAN_BASE = "<?php echo e(url('/layanan')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\cuci_helm\resources\views/layanan/index.blade.php ENDPATH**/ ?>