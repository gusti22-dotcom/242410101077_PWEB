...
<div class="stat-grid" style="margin-bottom:24px">
    <div class="stat-card green">
        ...
        <div class="stat-value" style="font-size:18px" id="statTotalPendapatan">Rp <?php echo e(number_format($totalBulanIni, 0, ',', '.')); ?></div>
    ...
    <div class="stat-card blue">
        ...
        <div class="stat-value" id="statTotalPesanan"><?php echo e($totalPesanan); ?></div>
    ...
    <div class="stat-card orange">
        ...
        <div class="stat-value" style="font-size:18px" id="statRataHari">
            Rp <?php echo e($laporanHarian->count() > 0 ? number_format($totalBulanIni / $laporanHarian->count(), 0, ',', '.') : '0'); ?>
    ...
    <div class="stat-card yellow">
        ...
        <div class="stat-value" id="statHariAktif"><?php echo e($laporanHarian->count()); ?></div>
...
<div class="card mb-4">
    <div class="card-header">
        <div>
            ...
            <div class="card-subtitle" id="chartSubtitle">
                ...
                ?>
                <?php echo e($namaBulan[$filterBulan] ?? ''); ?> <?php echo e($filterTahun); ?>

            </div>
        </div>
        <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;">
            <select class="form-control" id="laporanBulan" style="width:140px">
                <?php $__currentLoopData = $namaBulan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($val); ?>" <?php echo e($filterBulan == $val ? 'selected' : ''); ?>><?php echo e($name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <select class="form-control" id="laporanTahun" style="width:110px">
                <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($y); ?>" <?php echo e($filterTahun == $y ? 'selected' : ''); ?>><?php echo e($y); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
    ...
    <div class="chart-container" id="chartContainer">
        <?php if($laporanHarian->isNotEmpty()): ?>
            <div class="chart-bars" id="chartBars">
                <?php $__currentLoopData = $laporanHarian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $pct = $maxPendapatan > 0 ? ($item->pendapatan / $maxPendapatan * 100) : 0; ?>
                    <div class="chart-bar-wrap" title="Rp <?php echo e(number_format($item->pendapatan,0,',','.')); ?>">
                        <div class="chart-bar" data-percent="<?php echo e(number_format($pct,1)); ?>" style="height:<?php echo e(number_format($pct,1)); ?>%"></div>
                        <span class="chart-bar-label"><?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('d')); ?></span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        <?php else: ?>
        ...
        <div class="table-wrapper">
            <table>
                ...
                <tbody id="tbodyHarian">
                    <?php $__empty_1 = true; $__currentLoopData = $laporanHarian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td style="font-weight:600"><?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('d M Y')); ?></td>
                            <td><?php echo e($item->total_pesanan); ?></td>
                            <td><span class="badge badge-success"><?php echo e($item->selesai); ?></span></td>
                            <td style="font-weight:700;color:var(--primary);font-family:var(--font-display)">
                                Rp <?php echo e(number_format($item->pendapatan, 0, ',', '.')); ?>
        ...
        <div class="table-wrapper">
            <table>
                ...
                <tbody id="tbodyLayanan">
                    <?php $__empty_1 = true; $__currentLoopData = $laporanLayanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td style="font-weight:600"><?php echo e($item->nama_layanan); ?></td>
                            <td><?php echo e($item->total_pesanan); ?></td>
                            <td style="font-weight:700;color:var(--primary);font-family:var(--font-display)">
                                Rp <?php echo e(number_format($item->total_pendapatan, 0, ',', '.')); ?>
...
<footer>
    ...
    <div class="footer-copy">© <?php echo e(date('Y')); ?> Sistem Kasir Jasa Cuci Helm</div>
    <div class="footer-tag">Dibuat dengan <span>tujuan</span> untuk kemudahan kasir</div>
</footer>

<?php $__env->startPush('scripts'); ?>
<script>
const API_LAPORAN = "<?php echo e(route('api.laporan')); ?>";
const NAMA_BULAN  = {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\cuci_helm\resources\views/laporan/index.blade.php ENDPATH**/ ?>