...
<div class="stat-grid" style="grid-template-columns:repeat(2,1fr);max-width:500px;margin-bottom:24px">
    <div class="stat-card green">
        ...
        <div class="stat-value" style="font-size:18px" id="statPendapatan">Rp <?php echo e(number_format($totalPendapatan, 0, ',', '.')); ?></div>
    ...
    <div class="stat-card blue">
        ...
        <div class="stat-value" id="statTotal"><?php echo e($totalPesanan); ?></div>
    ...
    <div class="filter-bar">
        <div class="filter-group" style="min-width:110px;max-width:140px">
            ...
            <select class="form-control" id="filterTanggal">
                <option value="">-</option>
                <?php for($d = 1; $d <= 31; $d++): ?>
                    <option value="<?php echo e(str_pad($d, 2, '0', STR_PAD_LEFT)); ?>"
                        <?php echo e($filterTanggal == str_pad($d, 2, '0', STR_PAD_LEFT) ? 'selected' : ''); ?>>
                        <?php echo e($d); ?>
        ...
        <div class="filter-group" style="min-width:130px;max-width:170px">
            ...
            <select class="form-control" id="filterBulan">
                ...
                <?php $__currentLoopData = ['01'=>'Januari','02'=>'Februari','03'=>'Maret','04'=>'April','05'=>'Mei','06'=>'Juni','07'=>'Juli','08'=>'Agustus','09'=>'September','10'=>'Oktober','11'=>'November','12'=>'Desember']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tbody id="transaksiTbody">
                <?php $__empty_1 = true; $__currentLoopData = $transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><span style="font-weight:600"><?php echo e($t->nama_customer); ?></span></td>
                        <td><?php echo e($t->nama_layanan); ?></td>
                        <td><?php echo e($t->jumlah_helm); ?> helm</td>
                        <td style="font-weight:700;color:var(--primary);font-family:var(--font-display)">
                            Rp <?php echo e(number_format($t->total_harga, 0, ',', '.')); ?>

                        </td>
                        <td>
                            <span class="badge <?php echo e($t->status === 'selesai' ? 'badge-success' : 'badge-warning'); ?>">
                        ...
                        <td style="color:var(--text-secondary);font-size:13px">
                            ...
                            <br><span style="font-size:11px;color:var(--text-muted)"><?php echo e($t->created_at->format('H:i')); ?></span>
                        </td>
                    </tr>
...
<script>
const API_TRANSAKSI = "<?php echo e(route('api.transaksi')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\cuci_helm\resources\views/transaksi/index.blade.php ENDPATH**/ ?>